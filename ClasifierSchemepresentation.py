...
import scipy.io as sio
file_mat=sio.loadmat('/home/ricardo/Documentos/SYNC/ExperimentosGrafoHaralickS/trainNorm_augmented_Words300block_48L3_END.mat')


Xtrain = file_mat['X']
Ytrain = file_mat['Y']
file_mat=sio.loadmat('/home/ricardo/Documentos/SYNC/ExperimentosGrafoHaralickS/testNorm_augmented_Words300block_48L3_END.mat')
...
clf =  SVC(kernel=GeneralizedHistogramIntersection(), C=1)
#clf = VotingClassifier(estimators=[('QDA', MLPClassifier(alpha=1)),
...
#clf2 = SVC(kernel=GeneralizedHistogramIntersection(), C=1)
#clf2 =VotingClassifier(estimators=[('LSVC',SVC(kernel="linear", C=0.025)),
...
X_test3a = X_test[y_pred==3,:]
X_test3 = X_test3a[y_pred2==2,:]
