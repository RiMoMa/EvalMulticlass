...
files=sorted(glob.glob('/mnt/md0/ricardo/ResultadosCorrecion/train*.mat'), key=os.path.basename)
#/home/moncayor/moncayoR/ExperimentosGrafoHaralickS

import scipy.io as sio
from sklearn.model_selection import cross_val_score
Kfold = 10
FileResults='prueba_grafo_Partition_haralickMeansV2Good.npy'
...
#        fileTE = fileTrain[0:57]+'test'+fileTrain[62::]
        fileTE = fileTrain[0:46-9] + 'test' + fileTrain[51-9::]
