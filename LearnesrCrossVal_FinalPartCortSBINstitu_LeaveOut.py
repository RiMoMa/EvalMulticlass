...
files=sorted(glob.glob('/mnt/md0/ricardo/ResultadosCorreccionSB/train*.mat'), key=os.path.basename)
#/home/moncayor/moncayoR/ExperimentosGrafoHaralickS

import scipy.io as sio
from sklearn.model_selection import cross_val_score
Kfold = 10
FileResults='prueba_grafo_Partition_SUNNYBROOK_LEAVEOUT.npy'
...
#        fileTE = fileTrain[0:57]+'test'+fileTrain[62::]
        fileTE = fileTrain[0:40] + 'test' + fileTrain[45::]
       ...
       #Poner coeficientes de los histogramas
...
#                ,"2VS.1&3"]
        ...
        Name_test = ["1VS.2&3","2Vs3","2Vs3AllT"
           ]
        ScoreKval = []
        for z in range(len(Name_test)):
            ...
            if z == 0:
             ...
             #2vs3
                ...
                Xtesttotal = np.concatenate(( Xtest2, Xtest3), axis=0)
                Ytesttotal = np.concatenate((Ytest2/2, Ytest3*0), axis=0)
