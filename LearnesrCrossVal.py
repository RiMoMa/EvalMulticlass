import sys
sys.path.append("/home/ricardo/Documents/CodigosPython2019/Eval_SVM/pykernels-master/pykernels/graph/") 
...
Kfold = 10
FileResults='/home/ricardo/Documents/Doctorado/SYNC/ResultadosNPN/pruebaV3Test_grafo.npy'
...
## PARA LAS PRUEBAS DE VALIDACION
              ...
              #  X_test_Dtest = preprocessing.MinMaxScaler().fit_transform(Xtesttotal_Dtest)
               ...
               #     print(clf)
                    ...
                    score_KF.append((Name_test[z],name,fscore_aux,fscore_auxTest,y_test,y_pred_scores,Ytesttotal_Dtest,y_pred_Dtest_scores,confusion,confusionDtest))
